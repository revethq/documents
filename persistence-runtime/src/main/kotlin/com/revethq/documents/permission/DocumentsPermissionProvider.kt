            ...
            permissions =
                listOf(
                    ...
                    PermissionDeclaration(
                        action = Actions.Organization.LIST,
                        description = "List all organizations",
                        resourceType = "urn:revet:documents:{tenantId}:organization/*",
                    ),
                    PermissionDeclaration(
                        action = Actions.Organization.GET,
                        description = "Get an organization by ID",
                        resourceType = "urn:revet:documents:{tenantId}:organization/{organizationId}",
                    ),
                    PermissionDeclaration(
                        action = Actions.Organization.CREATE,
                        description = "Create a new organization",
                        resourceType = "urn:revet:documents:{tenantId}:organization/*",
                    ),
                    PermissionDeclaration(
                        action = Actions.Organization.UPDATE,
                        description = "Update an existing organization",
                        resourceType = "urn:revet:documents:{tenantId}:organization/{organizationId}",
                    ),
                    PermissionDeclaration(
                        action = Actions.Organization.DELETE,
                    ...
                    PermissionDeclaration(
                        ...
                        resourceType = "urn:revet:documents:{tenantId}:project/*",
                    ),
                    PermissionDeclaration(
                        action = Actions.Project.GET,
                        description = "Get a project by ID",
                        resourceType = "urn:revet:documents:{tenantId}:project/{projectId}",
                    ),
                    PermissionDeclaration(
                        action = Actions.Project.CREATE,
                        description = "Create a new project",
                        resourceType = "urn:revet:documents:{tenantId}:project/*",
                    ),
                    PermissionDeclaration(
                        action = Actions.Project.UPDATE,
                        description = "Update an existing project",
                        resourceType = "urn:revet:documents:{tenantId}:project/{projectId}",
                    ),
                    PermissionDeclaration(
                        action = Actions.Project.DELETE,
                        description = "Delete a project",
                        resourceType = "urn:revet:documents:{tenantId}:project/{projectId}",
                    ),
                    PermissionDeclaration(
                        action = Actions.Project.ADD_CLIENT,
                        description = "Add a client user to a project",
                        resourceType = "urn:revet:documents:{tenantId}:project/{projectId}",
                    ),
                    PermissionDeclaration(
                        action = Actions.Project.REMOVE_CLIENT,
                        description = "Remove a client user from a project",
                        resourceType = "urn:revet:documents:{tenantId}:project/{projectId}",
                    ),
                    PermissionDeclaration(
                        action = Actions.Project.ADD_TAG,
                        description = "Add a tag to a project",
                        resourceType = "urn:revet:documents:{tenantId}:project/{projectId}",
                    ),
                    PermissionDeclaration(
                        action = Actions.Project.REMOVE_TAG,
