...
class DocumentsUrn {
    ...
    fun document(
        tenant: String,
        id: UUID,
    ) = build(tenant, ResourceType.DOCUMENT, id)
    ...
    fun documentVersion(
        tenant: String,
        id: UUID,
    ) = build(tenant, ResourceType.DOCUMENT_VERSION, id)
    ...
    fun category(
        tenant: String,
        id: Long,
    ) = build(tenant, ResourceType.CATEGORY, id.toString())

    fun category(
        tenant: String,
        id: String,
    ) = build(tenant, ResourceType.CATEGORY, id)
    ...
    fun tag(
        tenant: String,
        id: Long,
    ) = build(tenant, ResourceType.TAG, id.toString())

    fun tag(
        tenant: String,
        id: String,
    ) = build(tenant, ResourceType.TAG, id)
    ...
    fun user(
        tenant: String,
        id: UUID,
    ) = build(tenant, ResourceType.USER, id)
    ...
    fun userPrincipal(
        tenant: String,
        userId: UUID,
    ): String = "urn:$namespace:iam:$tenant:user/$userId"
    ...
    fun groupPrincipal(
        tenant: String,
        groupId: UUID,
    ): String = "urn:$namespace:iam:$tenant:group/$groupId"
