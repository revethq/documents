...
class FileUploadResource
    ...
    constructor(
        ...
        @RequiresPermission(
            ...
            resource = "urn:revet:documents:{tenantId}:document-version/{documentVersionUuid}",
        )
        @Operation(
            ...
            APIResponse(
                ...
                content = [
                    Content(
                        ...
                        schema = Schema(implementation = com.revethq.documents.dto.DownloadResponse::class),
                    ),
                ],
            ),
        ...
        fun getDownloadUrl(
            ...
            val documentVersion =
                documentVersionRepository.findByUuid(uuid)
                    ?: return Response
            ...
            return Response
                .ok(
                    com.revethq.documents.dto.DownloadResponse(
        ...
        @APIResponses(
            APIResponse(
                ...
                content = [
                    Content(
                        mediaType = MediaType.APPLICATION_JSON,
                        schema = Schema(implementation = com.revethq.documents.dto.InitiateUploadResponse::class),
                    ),
                ],
            ),
        ...
        fun initiateUpload(request: com.revethq.documents.dto.InitiateUploadRequest): Response {
            // Look up document by UUID
            val document =
                documentService.getDocumentByUuid(request.documentUuid)
                    ?: return Response
                        .status(Response.Status.NOT_FOUND)
            ...
            val presignedUrl =
                storageService.generatePresignedUploadUrl(bucketId, s3Key, request.contentType)

            return Response
                .status(Response.Status.CREATED)
                .entity(
                    com.revethq.documents.dto.InitiateUploadResponse(
        ...
        @RequiresPermission(
            ...
            resource = "urn:revet:documents:{tenantId}:document-version/*",
        )
        @Operation(
        ...
        fun createVersionWithUrl(request: com.revethq.documents.dto.CreateDocumentVersionRequest): Response =
            try {
                val version =
                    documentVersionService.createVersion(
