...
class PrebuiltPolicies {
        ...
        return Policy(
            ...
            statements = listOf(
                Statement(
                    ...
                    resources = listOf(urn.bucketWildcard(tenantId))
                )
            )
        )
    }
     ...
     */
    fun organizationAdminPolicy(tenantId: String, organizationUuid: UUID): Policy {
        return Policy(
            id = UUID.randomUUID(),
     ...
     */
    fun organizationManagerPolicyForResource(tenantId: String, organizationUuid: UUID): Policy {
        return Policy(
            id = UUID.randomUUID(),
     ...
     */
    fun organizationViewerPolicyForResource(tenantId: String, organizationUuid: UUID): Policy {
        return Policy(
            id = UUID.randomUUID(),
     ...
     */
    fun projectAdminPolicy(tenantId: String, projectUuid: UUID): Policy {
        return Policy(
            id = UUID.randomUUID(),
     ...
     */
    fun projectManagerPolicyForResource(tenantId: String, projectUuid: UUID): Policy {
        return Policy(
            id = UUID.randomUUID(),
     ...
     */
    fun projectEditorPolicyForResource(tenantId: String, projectUuid: UUID): Policy {
        return Policy(
            id = UUID.randomUUID(),
     ...
     */
    fun projectViewerPolicyForResource(tenantId: String, projectUuid: UUID): Policy {
        return Policy(
            id = UUID.randomUUID(),
